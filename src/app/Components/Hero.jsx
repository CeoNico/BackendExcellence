  ...
  return (
    <main className='flex flex-col items-center justify-center'>
       ...
       <div className='flex items-center justify-center w-full '>
        <button className=' transition duration-500 p-2 hover:scale-110 shadow-xl shadow-black rounded-lg bg-slate-400 border-2 border-black text-black hover:text-white hover:bg-slate-900 hover:border-blue-500'>
